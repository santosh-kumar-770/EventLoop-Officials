    ...
    <div style={{ maxWidth: "700px", margin: "0 auto", padding: "40px 32px" }}>
      ...
      {!loading && inbox.length === 0 && (
        <div style={{ textAlign: "center", padding: "60px 0", background: "var(--surface)", borderRadius: "16px", border: "1px solid var(--border)" }}>
          ...
          <button onClick={() => navigate("/network")} style={{ padding: "10px 24px", borderRadius: "10px", border: "none", background: "linear-gradient(135deg, var(--blue), var(--indigo))", color: "white", fontSize: "14px", fontWeight: 600, cursor: "pointer" }}>
      ...
      {inbox.map(convo => (
        ...
        >
          <div style={{ width: "46px", height: "46px", borderRadius: "50%", background: "linear-gradient(135deg, var(--blue), var(--indigo))", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700, fontSize: "17px", color: "white", flexShrink: 0 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ fontSize: "13px", color: "var(--dim)", marginTop: "3px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
              {convo.is_mine ? "You: " : ""}{convo.last_message}
            </div>
          </div>
          {convo.unread_count > 0 && (
            <div style={{ background: "var(--blue)", color: "white", borderRadius: "50%", width: "20px", height: "20px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "11px", fontWeight: 700 }}>
              {convo.unread_count}
            </div>
          )}
        </div>
